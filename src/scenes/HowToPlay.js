class HowToPlay extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('HowToPlaySheet', './assets/HowToPlaySheet.png');
    ...
    create() {
        ...
        this.howToPlay = this.add.tileSprite((game.config.width/2), game.config.height/2, 760,440, 'HowToPlaySheet');

        this.menuButton = this.add.tileSprite(430, 535, 110, 50, 'menuButton').setOrigin(0, 0);
